...
$$\textcolor{black}{Radiosity} = \textcolor{goldenrod}{Radiant Emmitance} = \textcolor{blue}{emissivity} \cdot \textcolor{green}{Stefan's constant*} \cdot \textcolor{red}{Temperature^4}$$
...
- <span style="color: green">Stefan's constant</span> is $$\sigma\approx\frac{5.670}{10^{8}}\frac{W}{m^{2}K^{4}}$$
- <span style="color: green">Stefan's constant is $$\sigma\approx\frac{5.670}{10^{8}}\frac{W}{m^{2}K^{4}}$$ </span>
- And let the emittance be $$M_e = 11000 \frac{W}{m^2}$$.
