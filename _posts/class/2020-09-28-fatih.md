...
From 1880s to 1973, all recessions were temporary. But after that recession, inequality up and balanced growth page trended down.

If shocks have a persistance of .99, then 20 years from now, they're still 80% there. But with .96, they're only 40% there.
...
[Link to slides](HANDOUT_LECTURE4_TRENDS_21st_CENTURY_v5.pdf)

Thomas Kuhn, philosophy of science. Good book. Disagrees with Popper. Kuhn says science done by humans.

LIght wave vs particle pradigms.

When a paradigm shift happens, it unearths a goldmine of potential research.

In economics. Rational expectations is a paradigm. Lots of Nobels from the 70s. Take an old problem and look at it from a new perspective. First order implications of the idea of rational expectations.

After 30-40 years, we've exhausted the paradigm, and run into puzles that need  a new paradigm. Ex: equity premium puzzle in finance. Led to behavioral economics

In the last 20 years, the world has changed. Took as given balanced growth facts. And use Cobb Douglass because it implies a constant labor share. But facts are changing. At least 7-8 facts that are struggling on their own. (Maybe they're related.)
...
- Segregation
- labor share went volatile 1970-2000 and trended down after 2000
- Labor market flows seem to have moderated. Less flow of workers around. Less volatility. Less flow from Emplyed to Unemployed.
- Concetration in production. (returns, employment, productivity, etc.)
- Outsourcing, offshoring, subcontracting rose.
  - Lots of economists think this is related to the above, but no concrete theory of how.
- Some evidence that investment seems to have fallen. Like in investment-to-revenue share.
  - Some presentations will say it has plummeted. Others will say ehhh not really.
  - But at the very least, there's something wrong going on there.
- The Gig Economy

[ ] One of the best favors you can do for yourself is to sign up for NBERs mailing list. Lots of COVID dtuff. Don't read too much into it. Some of that is flimsy, and won't hold up. (**how? can't find link**)

#### Segregation is going up

- Workers more segregated across firms (by skill and other attributes)
- Households more segregated by income and education across regions
  - Rising across zip codes, not within zip codes. 
  - My neighbor and I going up at same rate, but diverging from other neighborhoods.
  - Even households across space are segregated by child-having
    - Edina has best schools around here. 
    - (See Fogley paper in JEP or Econemetrica about schools and taxes.)
    - Peer effects? From schools or neighbors? What would be the effects of busing someone in to this school?
    - Some work on this topic, but not good quality. Lack the data.
    - county with low income and high income neighborhood going to same school
- political polarization is up
  - Lanslide counties (20% margin): Landslide counties are more common.
  - Hoover institute, says acc to Mahdi, that parties have become closer. 
  - But Fatih says that he has read they are diverging.
    - Until 2000, People still vote across both parties, but politicians polarize
    - Now even individuals are polarized.

- Sorting is also up. HIgher skill workers seem to be concentrated at higher quality firms.
  - Rising coorelation betweeen firm-fixed-effects and worker-fixed-effects

These trends point to a global economy in flux. Related to outsourcing?

Talk about inequality going up took off in the recession. In 80s, less talk. If everyone in your tribe going up, you can't see the inequality between your tribe and another. Between SF and KS. 

Fatih says 
> Unemployment? 5%, and the average spell lasts 3 months. Miniscule welfare effect. But polarization? That's big.

Economics sometimes takes over other fields (like crime), when those fields don't have the right tools. Segregation and family are also like that. Don't have very good data on these family and education questions. Because they used to be studied by other fields.

On this topic, nobody has the full picture.

On marriage: Assortative matching restults dependent on definition. Education results seem more robust. Marriage coorelation slopes upward until the very top percent.


#### Labor Share

Strongly recommend reading Furman and Orzag (2016)
...
Fatih is very enthusiatic about hte new hire. Says he is very good advisor. from scandinavia, carnegie mellon

Fatih's advice is to initialize K-medoids using the result of K-means. In general, good technique to use computationally cheaper but 'worse' approach to 

You are sitting there staring at 20k lines of code. And it doesn't converge. Ask:

- Am I using the right method?
- Is there a bug in my code?
- Am I using the right method with no bugs, but have the wrong starting point.

Many of these things are not globally convergent.

When economists are taught computational methods, it's often underemphasized what your computational budget is. Working with big data, it might take several months of processor time.

Dendrograms

[NAICS](https://www.naics.com/search/) or NEPA are informally put-together heirarchical categorizations
18,131 public libraries, by the way.
